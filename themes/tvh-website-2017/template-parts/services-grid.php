<?php
// Display Services Grid on required pages
// 
?>
<div class="services-grid row small-up-1 medium-up-2 large-up-3" data-equalizer data-equalize-by-row="true">
	<div class="services-item column" data-equalizer-watch>
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tvh-ws-audiology-thumb.jpg">
		<h5>Audiology</h5>
		<h6>If you're having trouble with your hearing or issues with your hearing aids, our board-certified doctors of audiology can help.</h6>
	...
	<div class="services-item column" data-equalizer-watch>
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tvh-ws-dermatology-thumb.jpg">
		<h5>Dermatology</h5>
		<h6>Our board-certified dermatologist is an expert in the identification and treatment of all skin conditions. </h6>
		<a href="./dermatology"><button class="cta-button orange">Learn More</button></a>
	</div>
	<div class="services-item column" data-equalizer-watch>
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tvh-ws-endocrinology-thumb.jpg">
		<h5>Endocrinology</h5>
		<h6>From a nationally recognized diabetes program to advanced lab testing, our endocrinology team offers the best care and education.</h6>
	...
	<div class="services-item column" data-equalizer-watch>
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tvh-ws-gynecology-thumb.jpg">
		<h5>Gynecology</h5>
		<h6>Our board-certified gynecologists are committed to practicing evidence-based medicine to help women enjoy good health. </h6>
		<a href="./gynecology"><button class="cta-button orange">Learn More</button></a>
	</div>
	<div class="services-item column" data-equalizer-watch>
	...
	<div class="services-item column" data-equalizer-watch>
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tvh-ws-urology-thumb.jpg">
		<h5>Urology</h5>
		<h6>From sexual health issues, to incontinence, to diseases of the prostate, our urology experts can greatly enhance your life.</h6>
		<a href="./urology"><button class="cta-button orange">Learn More</button></a>
	</div>
</div>
