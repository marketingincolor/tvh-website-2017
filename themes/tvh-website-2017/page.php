...
<header class="front-hero">
	...
	<div class="tagline">
	<a href="https://www.youtube.com/watch?v=pKhpg_XfH-o&t&rel=0" rel="wp-video-lightbox"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/tvh-ws-btn-vid-launch.png" id="play_video" /></a>
	</div>
</header>
<?php else : ?>
	<?php get_template_part( 'template-parts/featured-image' ); ?>
