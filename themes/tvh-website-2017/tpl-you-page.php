<?php
/*
Template Name: YOU Main Landing Page
*/
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- End Google Tag Manager (noscript) -->        <div class="row expanded">
        ...
        <div class="row" data-equalizer>
            <div class="h3-social small-12 large-6 columns" data-equalizer-watch>
                ...
                <div class="row collapse small-up-4">
                    ...
                    <div class="column">
                        ...
                        <a href="javascript:;" onclick="copyToClipboard('#p1');" class="share-li" title="Copy this url to your clipboard">&nbsp;</a>
                    </div>
                </div>
            </div>
            <div class="h4-share small-12 large-6 columns" data-equalizer-watch>
                ...
                <a href="share-your-story" class="share-button" target="_blank">Share</a>
                <p>&nbsp;</p>
            </div>
        </div>
